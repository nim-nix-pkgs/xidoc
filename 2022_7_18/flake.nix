{
  ...
  inputs.src-xidoc-2022_7_18.flake = false;
  inputs.src-xidoc-2022_7_18.ref   = "refs/tags/2022.7.18";
  inputs.src-xidoc-2022_7_18.owner = "xigoi";
  inputs.src-xidoc-2022_7_18.repo  = "xidoc";
  inputs.src-xidoc-2022_7_18.type  = "github";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-xidoc-2022_7_18"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-xidoc-2022_7_18";
